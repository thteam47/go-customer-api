...
import (
	...
	gw "github.com/thteam47/common/api/customer-api"
...
func Run(lis net.Listener, grpc_port string, http_port string) error {
	...
	err := gw.RegisterCustomerServiceHandlerFromEndpoint(ctx, gwmux, grpc_port, dialOpts)
	if err != nil {
		return err
	}
	mux := http.NewServeMux()
	mux.Handle("/", gwmux)
	mux.HandleFunc("/customer-api/", serveSwaggerFile)
...
func serveSwaggerFile(w http.ResponseWriter, r *http.Request) {
	...
	p := strings.TrimPrefix(r.URL.Path, "/customer-api")
